...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\Account\Delete;
...
/**
 * @extends AbstractValueResolver<AccountDeleteCommand>
 */
final readonly class AccountDeleteCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return AccountDeleteCommand::class;
    }
