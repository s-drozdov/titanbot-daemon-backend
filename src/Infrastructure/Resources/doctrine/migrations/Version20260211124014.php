 ...
 */
final class Version20260211124014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devices (physical_id INT NOT NULL, is_active TINYINT NOT NULL, activity_type VARCHAR(255) NOT NULL, is_full_server_detection TINYINT NOT NULL, is_able_to_clear_cache TINYINT NOT NULL, go_time_limit_seconds INT NOT NULL, uuid BINARY(16) NOT NULL, current_account_uuid BINARY(16) DEFAULT NULL, UNIQUE INDEX UNIQ_11074E9AF5A63AC0 (physical_id), INDEX IDX_11074E9AA25D69D7 (current_account_uuid), INDEX idx__devices__physical_id (physical_id), PRIMARY KEY (uuid)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE habits (account_logical_id INT DEFAULT NULL, priority INT DEFAULT NULL, trigger_ocr VARCHAR(255) DEFAULT NULL, trigger_shell VARCHAR(255) DEFAULT NULL, action VARCHAR(255) NOT NULL, is_active TINYINT NOT NULL, updated_at DATETIME NOT NULL, uuid BINARY(16) NOT NULL, PRIMARY KEY (uuid)) DEFAULT CHARACTER SET utf8mb4');
