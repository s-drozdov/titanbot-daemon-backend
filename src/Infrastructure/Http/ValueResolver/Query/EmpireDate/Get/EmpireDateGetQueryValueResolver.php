...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Query\EmpireDate\Get;
...
/**
 * @extends AbstractValueResolver<EmpireDateGetQuery>
 */
final readonly class EmpireDateGetQueryValueResolver extends AbstractValueResolver
{
    ...
    {
        return EmpireDateGetQuery::class;
    }
