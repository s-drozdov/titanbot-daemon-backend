...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\Legion\Delete;
...
/**
 * @extends AbstractValueResolver<LegionDeleteCommand>
 */
final readonly class LegionDeleteCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return LegionDeleteCommand::class;
    }
