...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\Account\Create;
...
/**
 * @extends AbstractValueResolver<AccountCreateCommand>
 */
final readonly class AccountCreateCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return AccountCreateCommand::class;
    }
