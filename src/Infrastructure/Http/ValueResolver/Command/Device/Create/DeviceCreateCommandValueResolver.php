...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\Device\Create;
...
/**
 * @extends AbstractValueResolver<DeviceCreateCommand>
 */
final readonly class DeviceCreateCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return DeviceCreateCommand::class;
    }
