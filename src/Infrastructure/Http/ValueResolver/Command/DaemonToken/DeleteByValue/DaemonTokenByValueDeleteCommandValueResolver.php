...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\DaemonToken\DeleteByValue;
...
/**
 * @extends AbstractValueResolver<DaemonTokenByValueDeleteCommand>
 */
final readonly class DaemonTokenByValueDeleteCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return DaemonTokenByValueDeleteCommand::class;
    }
