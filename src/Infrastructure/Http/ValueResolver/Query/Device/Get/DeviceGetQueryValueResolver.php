...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Query\Device\Get;
...
/**
 * @extends AbstractValueResolver<DeviceGetQuery>
 */
final readonly class DeviceGetQueryValueResolver extends AbstractValueResolver
{
