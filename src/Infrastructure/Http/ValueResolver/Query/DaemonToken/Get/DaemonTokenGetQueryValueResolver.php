...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Query\DaemonToken\Get;
...
/**
 * @extends AbstractValueResolver<DaemonTokenGetQuery>
 */
final readonly class DaemonTokenGetQueryValueResolver extends AbstractValueResolver
{
    ...
    {
        return DaemonTokenGetQuery::class;
    }
