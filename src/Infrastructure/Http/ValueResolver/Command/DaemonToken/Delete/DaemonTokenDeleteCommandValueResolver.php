...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\DaemonToken\Delete;
...
/**
 * @extends AbstractValueResolver<DaemonTokenDeleteCommand>
 */
final readonly class DaemonTokenDeleteCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return DaemonTokenDeleteCommand::class;
    }
