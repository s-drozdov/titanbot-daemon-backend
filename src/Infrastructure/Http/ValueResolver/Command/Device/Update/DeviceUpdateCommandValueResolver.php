...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\Device\Update;
...
/**
 * @extends AbstractValueResolver<DeviceUpdateCommand>
 */
final readonly class DeviceUpdateCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return DeviceUpdateCommand::class;
    }
