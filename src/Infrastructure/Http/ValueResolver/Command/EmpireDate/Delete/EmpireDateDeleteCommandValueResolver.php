...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\EmpireDate\Delete;
...
/**
 * @extends AbstractValueResolver<EmpireDateDeleteCommand>
 */
final readonly class EmpireDateDeleteCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return EmpireDateDeleteCommand::class;
    }
