...
enum Action: string
{
    case AccountPost = 'account_post';
    case AccountGet = 'account_get';
    case AccountIndex = 'account_index';
    case AccountUpdate = 'account_put';
    case AccountDelete = 'account_delete';

    case DaemonTokenPost = 'daemon_token_post';
    ...
    case DevicePost = 'device_post';
    case DeviceGet = 'device_get';
    case DeviceIndex = 'device_index';
    case DeviceUpdate = 'device_put';
    case DeviceDelete = 'device_delete';

    case EmpireDatePost = 'empire_date_post';
