...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\Habit\Delete;
...
/**
 * @extends AbstractValueResolver<HabitDeleteCommand>
 */
final readonly class HabitDeleteCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return HabitDeleteCommand::class;
    }
