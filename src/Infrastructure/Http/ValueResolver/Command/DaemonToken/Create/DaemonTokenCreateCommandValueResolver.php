...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\DaemonToken\Create;
...
/**
 * @extends AbstractValueResolver<DaemonTokenCreateCommand>
 */
final readonly class DaemonTokenCreateCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return DaemonTokenCreateCommand::class;
    }
