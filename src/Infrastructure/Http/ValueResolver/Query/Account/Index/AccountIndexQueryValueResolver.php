...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Query\Account\Index;
...
/**
 * @extends AbstractValueResolver<AccountIndexQuery>
 */
final readonly class AccountIndexQueryValueResolver extends AbstractValueResolver
{
    ...
    {
        return AccountIndexQuery::class;
    }
