...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\Device\Delete;
...
/**
 * @extends AbstractValueResolver<DeviceDeleteCommand>
 */
final readonly class DeviceDeleteCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return DeviceDeleteCommand::class;
    }
