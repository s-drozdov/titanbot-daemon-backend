...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Query\Account\Get;
...
/**
 * @extends AbstractValueResolver<AccountGetQuery>
 */
final readonly class AccountGetQueryValueResolver extends AbstractValueResolver
{
