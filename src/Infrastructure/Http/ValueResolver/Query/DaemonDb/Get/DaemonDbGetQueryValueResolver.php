...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Query\DaemonDb\Get;
...
/**
 * @extends AbstractValueResolver<DaemonDbGetQuery>
 */
final readonly class DaemonDbGetQueryValueResolver extends AbstractValueResolver
{
