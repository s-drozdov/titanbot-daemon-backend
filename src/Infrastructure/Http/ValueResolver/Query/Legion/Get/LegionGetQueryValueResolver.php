...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Query\Legion\Get;
...
/**
 * @extends AbstractValueResolver<LegionGetQuery>
 */
final readonly class LegionGetQueryValueResolver extends AbstractValueResolver
{
