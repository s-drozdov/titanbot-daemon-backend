...
namespace Titanbot\Daemon\Infrastructure\Http\ValueResolver\Command\Device\ResetInNeedUpdate;
...
/**
 * @extends AbstractValueResolver<DeviceResetInNeedUpdateCommand>
 */
final readonly class DeviceResetInNeedUpdateCommandValueResolver extends AbstractValueResolver
{
    ...
    {
        return DeviceResetInNeedUpdateCommand::class;
    }
